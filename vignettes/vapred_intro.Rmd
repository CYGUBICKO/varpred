...
To illustrate this, we use `mtcars` dataset to fit two models: 1) one without interaction, and 2) one with interaction between predictors.
...
- `getmeans`: calculates marginal means of the estimates to compare with the data mean (mean of observed data)
